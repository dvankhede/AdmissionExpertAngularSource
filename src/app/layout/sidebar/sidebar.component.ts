...
export class SidebarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.profService.getProfileDetails().subscribe(res => {console.log(res),
      this.profService.profObj = res;
            // this.profService.userObj.firstName = this.profObj.firstName;
            // this.profService.userObj.lastName = this.profObj.lastName;
            console.log('The user is',this.profService.profObj);
