...
export class ChartjsComponent {
	...
	// start radar chart
	public radarChartLabels: string[] = ['A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7'];
	...
	public doughnutChartLabels: string[] = ['Project 1', 'Project 2', 'Project 3', 'Project 4'];
	...
	public scatterChartLabels: Array<any> = ['January', 'February', 'March', 'April', 'May', 'June', 'July'];
	...
	// pie chart start
	public pieChartLabels: string[] = ['Project 1', 'Project 2', 'Project 3', 'Project 4'];
	...
	// Polar chart start
	public polarAreaChartLabels: string[] = ['Project 1', 'Project 2', 'Project 3', 'Project 4'];
